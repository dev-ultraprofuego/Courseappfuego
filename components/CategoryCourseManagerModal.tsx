...
const CategoryCourseManagerModal: React.FC<ExtendedCategoryCourseManagerModalProps> = ({ isOpen, onClose, category, allCourses, categoryCourseLinks, onSave, onUpdateCategoryConfig, onEditCourse, theme, t }) => {
