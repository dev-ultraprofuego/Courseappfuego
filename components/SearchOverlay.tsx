...
const SearchOverlay: React.FC<SearchOverlayProps> = ({ isOpen, onClose, theme, courses, config }) => {
    ...
    const themeClasses = {
        ...
        pristine: {
            title: "from-[#ff6b81] to-[#ff4757]",
            closeButtonBg: "bg-[rgba(255,71,87,0.06)]",
            closeButtonBorder: "border-[rgba(255,71,87,0.12)]",
            closeButtonText: "text-[#ff6b81]",
            searchBorder: "border-[rgba(255,71,87,0.12)]",
            searchIcon: "text-[#ff6b81]",
            searchButton: "bg-gradient-to-r from-[#ff6b81] to-[#ff4757]",
            resultsBorder: "border-[rgba(255,71,87,0.12)]",
            resultHover: "hover:bg-[rgba(255,71,87,0.06)]",
            resultActive: "bg-[rgba(255,71,87,0.12)]",
            highlightText: "text-[#ff6b81]",
            highlightBg: "bg-[rgba(255,71,87,0.15)]",
