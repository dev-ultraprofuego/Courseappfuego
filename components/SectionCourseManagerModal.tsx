...
const SectionCourseManagerModal: React.FC<ExtendedSectionCourseManagerModalProps> = ({ isOpen, onClose, section, allCourses, allCategories, onSave, onEditCourse, theme, t }) => {
