                                    ...
                                    <td className={cellStyle}>
                                        <div className="flex flex-wrap gap-1.5">
                                            {course.categories.slice(0, 3).map(cat => (
                                                <span key={cat} className="inline-flex items-center px-1.5 py-0.5 rounded text-[9px] font-medium bg-[#151918] text-gray-400 border border-white/10 whitespace-nowrap">
                                                    {cat}
                                                </span>
                                            ))}
